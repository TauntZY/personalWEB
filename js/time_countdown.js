...
const colors = ["#33B5E5","#0099CC","#AA66CC","#9933CC","#99CC00","#669900","#FFBB33","#FF8800","#FF4444",
    "#CC0000","blue","red","green","orange"]

window.onload = function(){
    WINDOW_WIDTH = document.getElementById("time_canvas").clientWidth
    WINDOW_HEIGHT = document.getElementById("time_canvas").clientHeight
    ...
    for( var i = 0 ; i < balls.length ; i ++ ){
       ...
       balls[i].x += balls[i].vx;
        ...
        if( balls[i].y >= WINDOW_HEIGHT-RADIUS ){
            ...
            balls[i].vy = - Math.abs(balls[i].vy)*0.85;
        }
    }
    var cnt = 0
